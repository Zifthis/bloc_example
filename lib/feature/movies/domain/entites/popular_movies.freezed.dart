...
mixin _$PopularMovies {
  ...
  List<MovieResults>? get movieResults => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      page: freezed == page
          ...
          : page // ignore: cast_nullable_to_non_nullable
              as int?,
      movieResults: freezed == movieResults
          ? _value.movieResults
...
class _$_PopularMovies implements _PopularMovies {
  ...
  @override
  String toString() {
    return 'PopularMovies(page: $page, movieResults: $movieResults, totalPages: $totalPages, totalResults: $totalResults)';
  }
